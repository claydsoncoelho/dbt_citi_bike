...
GRANT SELECT ON ALL TABLES IN SCHEMA DW.PROD TO ROLE PROD_ROLE_REPORT;
...
--------------------------------------------------------------------------
USE ROLE SYSADMIN;
GRANT CREATE SCHEMA ON DATABASE STG_DATASTORE TO ROLE TEST_ROLE_TRANSFORMATION;
GRANT CREATE SCHEMA ON DATABASE DATASTORE TO ROLE TEST_ROLE_TRANSFORMATION;
GRANT CREATE SCHEMA ON DATABASE STG_DW TO ROLE TEST_ROLE_TRANSFORMATION;
GRANT CREATE SCHEMA ON DATABASE DW TO ROLE TEST_ROLE_TRANSFORMATION;
GRANT CREATE SCHEMA ON DATABASE DBT_PROJECT_EVALUATOR TO ROLE TEST_ROLE_TRANSFORMATION;


USE ROLE TEST_ROLE_TRANSFORMATION;
show objects in DW.dbt_cloud_pr_808183_27 limit 10000;
...
URL = 'azure://citibike4clay.blob.core.windows.net/citi-bike/data/'
CREDENTIALS = (
    AZURE_SAS_TOKEN = 'sp=rl&st=2025-02-04T10:04:50Z&se=2025-12-30T18:04:50Z&spr=https&sv=2022-11-02&sr=c&sig=LV17UiOKHe%2FLXQvoqyHGNkPNQIyZ%2BX7lNQPQnPI9js8%3D');
